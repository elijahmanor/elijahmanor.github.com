...
export default (theme, images) => <SlideSet>
  ...
  <Slide transition={["spin", "slide"]} bgColor="primary">
    <Terminal
      isMaximized
      title="pre & post lifecycle hooks"
      output={[
        <div>
  ...
  "scripts": {
    "start": "node index.js",
    "test": "`}</span>
              <Highlight>{"npm run lint &&"}</Highlight>
              <span>{` mocha spec/ --require babel-register",
  ...
  "scripts": {
    "start": "node index.js",
    `}</span>
              <Changed>{"\"pretest\": \"npm run lint\","}</Changed>
              <span>{`
    "test": `}</span>
              <Highlight>{"\"mocha spec/ --require babel-register\""}</Highlight><span>{`,
    "lint": "npm-run-all lint:**",
    "lint:js": "eslint --cache --fix ./",
    "lint:css": "stylelint '**/*.scss' --syntax scss",
    "lint:css:fix": "stylefmt -R src/"
  ...
  "scripts": {
    ...
    `}</span>
              <Changed>{`"cover": "nyc npm t",
"postcover": "rm -rf .nyc_output",
"cover:open": "open coverage/index.html",`}</Changed>
              <span>{`
    "lint": "npm-run-all lint:**",
    "lint:js": "eslint --cache --fix ./",
    "lint:css": "stylelint '**/*.scss' --syntax scss",
