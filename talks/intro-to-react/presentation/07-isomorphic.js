...
`}
      ...
      <Fill style={{ leftRight: "0.5rem" }}>
        ...
        >
          ...
          is deprecated and you should start using{" "}
          <Code bgColor="#ccc" textSize={30}>
            hydrate()
          </Code>{" "}
          instead.
        </Text>
        <Text textColor="primary" textSize={32}>
          <Code bgColor="#ccc" textSize={30}>
            render()
          </Code>{" "}
          will no longer work in React v17 to hydrate
    ...
    <Link
      textColor="tertiary"
      textSize={32}
      href="https://hackernoon.com/whats-new-with-server-side-rendering-in-react-16-9b0d78585d67"
  ...
  <Slide bgColor="secondary">
    ...
    <Link
      textColor="tertiary"
      href="http://react-router-mega-demo.herokuapp.com/"
    >
