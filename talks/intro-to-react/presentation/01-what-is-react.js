...
export default (theme, images) => [
  ...
  <Slide bgColor="secondary" textColor="primary">
    ...
    <Text textColor="primary">
      ...
      >
        <Text bold caps textColor="tertiary">
          Facebook's Sites Using React Wiki
        </Text>
      </Link>
    </Text>
  </Slide>,
  ...
  <Slide bgColor="black">
    ...
    <Appear>
      <BlockQuote>
        <Quote textSize={52}>
          React components are far more powerful than
          Angular templates; they should be compared with
          Angular's directives instead
        </Quote>
        <Cite>
          Pete Hunt (
          <Link
            href="http://www.quora.com/Pete-Hunt/Posts/Facebooks-React-vs-AngularJS-A-Closer-Look)"
            style={{ display: "inline-block" }}
          >
            <Text textColor="tertiary" textSize={24}>
              Quora
...
var NoteBox = React.createClass({
  ...
  <Slide bgColor="black">
    ...
    <Layout>
      <Fill style={{ marginRight: "0.5rem" }}>
        <List textColor="primary">
          <ListItem>
            Re-rendering the whole app on every update is
            not efficient
          </ListItem>
          <ListItem>
            The Virtual DOM will only update what is
            necessary
          </ListItem>
          <ListItem>
      ...
      <Fill style={{ marginLeft: "0.5rem" }}>
        <BlockQuote>
          <Quote textSize={42}>
            I tend to think of React as Version Control for
            the DOM
          </Quote>
          <Cite>AdonisSMU </Cite>
        </BlockQuote>
  ...
  <Slide bgColor="black">
    ...
    <Mermaid name="diagram">
      graph LR; classDef action
      fill:#65B9CA,stroke:#FFFFFF,stroke-width:4px,color:white;
      classDef dispatcher
      fill:#444142,stroke:#FFFFFF,stroke-width:4px,color:white;
      classDef store
      fill:#294552,stroke:#FFFFFF,stroke-width:4px,color:white;
      classDef view
      fill:#5FAF6A,stroke:#FFFFFF,stroke-width:4px,color:white;
      Action1(Action)-->Dispatcher(Dispatcher);
      Dispatcher-->Store(Store); Store-->View(View);
      View-->Action2(Action); Action2-->Dispatcher; class
      Action1,Action2 action; class Dispatcher dispatcher;
      class Store store; class View view;
    </Mermaid>
    <Text textColor="primary">
      We will upack this later in the presentation
    </Text>
  </Slide>,
  <Slide bgColor="secondary">
    ...
    <Layout>
      <Fill>
        <BlockQuote>
          <Quote textSize={38}>
            ...you can set the directionality of it to be
            2-Way Data Binding. That actually seems to be a
            good idea until you have a large scale
            application and then it turns out you have no
            idea whats going on... and turns out to be an
            anti-pattern for large apps.
          </Quote>
          <Cite>
            <Link
              href="https://www.youtube.com/watch?v=uD6Okha_Yj0#t=1785"
              style={{ display: "inline-block" }}
            >
              <Text textColor="tertiary" textSize={24}>
                Misko Hevery
      ...
      <Fill>
        <Image
          src={images.twoWayDataFlow.replace("/", "")}
          style={{ marginBottom: "1rem" }}
        />
        <Text textSize={24} textColor="primary">
          Image from{" "}
          <Link
            href="https://medium.com/@davidsouther/song-flux-e1f9786579f6"
            style={{ display: "inline-block" }}
          >
            <Text textColor="tertiary" textSize={24}>
              David Souther
  ...
  <Slide bgColor="black">
    ...
    <Text textSize={24} textColor="primary">
      Tom Ochino's{" "}
      <Link
        href="https://www.youtube.com/watch?v=KVZ-P-ZI6W4#t=868"
        style={{ display: "inline-block" }}
      >
        <Text textColor="tertiary" textSize={24}>
  ...
  <Slide bgColor="secondary">
    <Heading fit style={{ marginBottom: "2rem" }}>
      Getting Started
    </Heading>
    <Layout style={{ marginTop: "1rem" }}>
      <Fill>
        ...
        >
          Once you know the basics (we'll cover those in
          this talk), then you can get started building
          locally with the{" "}
          <Link
        ...
        >
          Or, if you just want to tinker online then{" "}
          <Link
      ...
      <Fill>
        <iframe
          src="https://codesandbox.io/embed/92yzpkw2xw?autoresize=1&codemirror=1"
          frameBorder="0"
          style={{
            overflow: "hidden",
            height: "60vh",
