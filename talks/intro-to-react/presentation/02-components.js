...
export default (theme, images) => ([
  ...
  <Slide bgColor="black">
    <Heading caps fit>State Machines</Heading>
    <BlockQuote>
      <Quote>
        <Heading textColor="primary" size={5}>Components are Just State Machines</Heading>
        <Text textColor="primary" textSize={36} style={{ margin: "1rem 0" }}>React thinks of UIs as simple state machines. By thinking of a UI as being in various states and rendering those states, it's easy to keep your UI consistent.</Text>
        <Text textColor="primary" textSize={36}>In React, you simply update a component's state, and then render a new UI based on this new state. React takes care of updating the DOM for you in the most efficient way.</Text>
      </Quote>
      <Cite>
        <Link href="https://facebook.github.io/react/docs/interactivity-and-dynamic-uis.html#components-are-just-state-machines" style={{ display: "inline-block" }}>
          <Text textColor="tertiary" textSize={22}>Interactivity and Dynamic UIs</Text>
        </Link>
      </Cite>
    </BlockQuote>
  </Slide>,
  <Slide bgColor="secondary" >
    ...
    <BlockQuote>
      ...
      <Cite>
        <Link href="http://en.wikiquote.org/wiki/Linus_Torvalds#2000-04" style={{ display: "inline-block" }}>
          <Text textColor="tertiary" textSize={34}>Linus Torvalds</Text>
        </Link>
      </Cite>
    </BlockQuote>
  ...
  <CodeSlide
    ...
    ranges={[
      ...
      { loc: [2, 5], note: "HelloWorld component is just a function!" },
      { loc: [6, 10], note: "ReactDOM.render creates the component, starts the framework, and injects HTML into a DOM node." }
    ]}
  />,
  <Slide maxHeight="100vh" maxWidth="90vw" bgColor="secondary">
    <Heading caps fit>Hello, world</Heading>
    <ComponentPlayground theme="light" scope={{ Terminal }} code={snippets.helloWorldFunction.play} />
  </Slide>,
  <CodeSlide
    lang="jsx"
    ...
    ranges={[
      ...
      { loc: [2, 4], note: "You can even use ECMAScript 2015 (ES6) arrow functions!" }
    ]}
  />,
  <CodeSlide
    lang="jsx"
    ...
    ranges={[
      ...
      { loc: [3, 10], note: "Can use the ECMAScript 2015 (ES6) class and extend React.Component" },
      { loc: [4, 9], note: "The render method is required. You can think of this as your template." }
    ]}
  />,
  <CodeSlide
    lang="jsx"
    ...
    ranges={[
      { loc: [0, 15], title: "Hello, world" },
      { loc: [3, 10], note: "React.createClass is how we defined a component in React v15.4 and below." }
    ]}
  />,
  <CodeSlide
    lang="jsx"
    ...
    ranges={[
      { loc: [0, 15], title: "Hello, world" },
      { loc: [1, 3], note: "After React v15.5+ you can migrate React.createClass to  createReactClass" },
      { loc: [0, 15], note: "You can use jscodeshift to migrate your legacy components" }
    ]}
  />,
  <Slide bgColor="secondary">
    <Heading caps fit>Markup in my JavaScript... WHAT!?</Heading>
    <Layout>
      <Fill style={{ marginRight: "0.5rem" }}>
        <Image src={images.iAmDeveloperJsx.replace("/", "")} />
      </Fill>
      <Fill style={{ marginLeft: "0.5rem" }}>
        <Image src={images.ohNoYes.replace("/", "")} style={{ minWidth: "100%" }} />
      </Fill>
    </Layout>
  </Slide>,
  <Slide bgColor="secondary">
    ...
    <Layout>
      <Fill>
        <List textColor="primary">
          <ListItem>Templates separate technologies, not concerns</ListItem>
          <ListItem>Allows you to focus on building components, not templates</ListItem>
          <ListItem>Combining Markup and JavaScript reduces context switching</ListItem>
        </List>
      </Fill>
      <Fill>
        <BlockQuote>
          <Quote textSize={44}>React component is "...a highly cohesive building block for UIs loosely coupled with other components."</Quote>
          <Cite>
            <Link href="http://www.slideshare.net/floydophone/react-preso-v2" style={{ display: "inline-block" }}>
              <Text textColor="tertiary" textSize={24}>Pete Hunt</Text>
            </Link>
          </Cite>
        </BlockQuote>
      </Fill>
  ...
  <Slide bgColor="secondary">
    ...
    <CodePane lang="jsx" theme="light" source={`'use strict';
...
`}
  ...
  />,
  <Slide maxHeight="100vh" maxWidth="90vw" bgColor="secondary">
    <Heading caps fit>Let's Get Dynamic</Heading>
    <ComponentPlayground theme="light" scope={{ PropTypes }} code={snippets.letsGetDynamic.play} />
  </Slide>,
  <CodeSlide
    lang="jsx"
  ...
  <CodeSlide
    ...
    ranges={[
      ...
      { loc: [3, 12], note: "When using a React class you can access  props off the this implicit parameter." },
      { loc: [7, 8], note: "Feel free to use destructuring as well here... const { name } = this.props;" }
    ]}
  />,
  <CodeSlide
    lang="jsx"
    ...
    ranges={[
      ...
      { loc: [2, 3], note: "In React 15.5+, import  prop-types instead of  React.PropTypes (migration codemod)" },
      { loc: [13, 16], note: "Check the types of the  props during development with propTypes." },
      { loc: [13, 16], note: "array, bool, func, number, object, string, node, element, etc..." }
    ]}
  />,
  <CodeSlide
    lang="jsx"
    ...
    ranges={[
      ...
      { loc: [5, 8], note: "Alternataively, you can use a public class field" }
    ]}
  />,
  <CodeSlide
    lang="jsx"
    ...
    ranges={[
      ...
      { loc: [4, 8], note: "Provide default state by assigning object from contructor" },
  ...
  />,
  <Slide maxHeight="100vh" maxWidth="90vw" bgColor="secondary">
    <Heading caps fit>Let's Look at State</Heading>
    <ComponentPlayground theme="light" scope={{ PropTypes }} code={snippets.letsLookAtState.play} />
  </Slide>,
  <Slide bgColor="secondary">
    <Heading caps size={2} textColor="tertiary">Déjà Vu</Heading>
    <Link href="https://twitter.com/iamdevloper/status/567363727176253440" style={{ display: "inline-block" }}>
      <Image src={images.iAmDeveloperOnClick.replace("/", "")} />
    </Link>
  </Slide>,
  <CodeSlide
    lang="jsx"
    ...
    ranges={[
      ...
      { loc: [8, 13], note: "As of React v0.13+ you can pass a callback function to  this.setState. React will pass the current state &  props and you return the new state" }
    ]}
  />,
  <CodeSlide
    lang="jsx"
    ...
    ranges={[
      ...
      { loc: [4, 5], note: "Instead of using a contructor, you can use a public class field" }
    ]}
  />,
  <CodeSlide
    lang="jsx"
    ...
    ranges={[
      ...
      { loc: [13, 18], note: "Manually binding event handlers can be slow, annoying, and verbose..." },
      { loc: [14, 15], note: "Thankfully there are other alternatives" }
    ]}
  />,
  <CodeSlide
    lang="jsx"
    ...
    ranges={[
      { loc: [0, 30], title: <div><div>Bind Event Handlers</div><div>Constructor</div></div> },
      { loc: [7, 9], note: "Do the binding once in the constructor" },
      { loc: [18, 22], note: "Reference the prebinded event handler" }
    ]}
  />,
  <CodeSlide
    lang="jsx"
    ...
    ranges={[
      { loc: [0, 29], title: <div><div>Bind Event Handlers</div><div>Class Field</div></div> },
      { loc: [5, 10], note: "Use the experimental (stage 3) Property Initializer Syntax" },
      { loc: [13, 17], note: "Reference the prebinded event handler" }
    ]}
  />,
  <CodeSlide
    lang="jsx"
    ...
    ranges={[
      { loc: [0, 29], title: <div><div>Bind Event Handlers</div><div>Inline</div></div> },
      { loc: [13, 18], note: "Add inline event handler passing along the event argument" },
      { loc: [14, 15], note: "This is not preferred as it creates new binding function on each render. Prefer approaches like Constructor or Property Initializer Syntax" }
    ]}
  />,
  <Slide bgColor="secondary">
    <Link href="https://facebook.github.io/react/docs/component-specs.html#lifecycle-methods" style={{ display: "inline-block" }}>
      <Text textColor="tertiary">Component LifeCycle</Text>
    </Link>
    <List textColor="primary">
      <Appear><ListItem style={{ marginBottom: "1rem" }} textSize={32}><S type="bold">componentDidMount</S> – Fired once, after initial rendering occurs. Can use <Code bgColor="#ccc" textSize={30}>ReactDOM.findDOMNode</Code></ListItem></Appear>
      <Appear><ListItem style={{ marginBottom: "1rem" }} textSize={32}><S type="bold">componentDidUpdate</S> - Fired after the component's updates are made to the DOM</ListItem></Appear>
      <Appear><ListItem style={{ marginBottom: "1rem" }} textSize={32}><S type="bold">componentWillReceiveProps</S> – Fired when a component is receiving new props. You might want to <Code bgColor="#ccc" textSize={30}>this.setState</Code> depending on the props</ListItem></Appear>
      <Appear><ListItem style={{ marginBottom: "1rem" }} textSize={32}><S type="bold">shouldComponentUpdate</S> - Fired before rendering when new props or state are received. <Code bgColor="#ccc" textSize={30}>return false</Code> if you know an update isn't needed</ListItem></Appear>
      <Appear><ListItem textSize={32}><S type="bold">componentWillUnmount</S> – Fired immediately before a component is unmounted from the DOM. Good place to remove message listeners or general clean up</ListItem></Appear>
    </List>
  </Slide>,
  <CodeSlide
    lang="jsx"
  ...
  />,
  <Slide maxHeight="100vh" maxWidth="90vw" bgColor="secondary">
    <Heading caps fit>Reference to Children Nodes</Heading>
    <ComponentPlayground theme="light" scope={{ PropTypes, Component }} code={snippets.refsToChildren.play} />
  </Slide>,
  <CodeSlide
    lang="jsx"
    ...
    ranges={[
      ...
      { loc: [3, 5], note: "functional components don't have instances!" },
      { loc: [14, 16], note: "Component passed to ref will be null" },
      { loc: [7, 12], note: "therefore, console.log will be null" }
    ]}
  />,
  <CodeSlide
    lang="jsx"
    ...
    ranges={[
      ...
      { loc: [5, 10], note: "in componentDidMount you can get the top level element with findDOMNode method" }
    ]}
  />,
  <Slide maxHeight="100vh" maxWidth="90vw" bgColor="secondary">
    <Heading caps fit>Current DOM Node</Heading>
    <ComponentPlayground theme="light" scope={{ PropTypes, Component, ReactDOM }} code={snippets.getCurrentNode.play} />
  </Slide>,
  <CodeSlide
    lang="jsx"
    ...
    ranges={[
      ...
      { loc: [6, 12], note: "Save off props into state for later use" },
      { loc: [29, 34], note: "Map over the names array from state and convert to list items" },
      { loc: [34, 42], note: "Button to Sort and Filter Scotts" },
      { loc: [12, 17], note: "Sort the names array and assign back to setState" },
      { loc: [17, 26], note: "Filter only names that match \"Scott\" and then update state" }
    ]}
  />,
  <CodeSlide
    lang="jsx"
    ...
    ranges={[
      ...
      { loc: [6, 10], note: "Destructuring & Property Value Shorthand" },
      { loc: [15, 22], note: "Arrow function, Implicit Return, includes method" },
      { loc: [22, 36], note: "Destructuring, Arrow function, Implicit Return, Property Value Shorthand" }
    ]}
  />,
  <Slide maxHeight="100vh" maxWidth="90vw" bgColor="secondary">
    <Heading caps fit>Dealing with Lists</Heading>
    <ComponentPlayground theme="light" scope={{ PropTypes, Component, ReactDOM }} code={snippets.dealingWithLists.play} />
  </Slide>,
  <Slide bgColor="secondary">
    <Heading caps fit>It's Just JavaScript</Heading>
    <Layout>
      <Fill style={{ marginRight: "0.5rem" }}>
        <Link href="https://twitter.com/ryanflorence/status/577685415919898625" style={{ display: "inline-block" }}>
          <Image src={images.ryanFlorenceJavaScript.replace("/", "")} />
        </Link>
      </Fill>
      <Fill style={{ marginLeft: "0.5rem" }}>
        <Image src={images.fastTyping.replace("/", "")} style={{ minWidth: "100%" }} />
      </Fill>
    </Layout>
  </Slide>
//   MarkdownSlides`
